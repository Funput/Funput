...
data class SuggestionBarSpec(
    ...
    init {
        ...
        require(systemInputMethodKey == null || systemInputMethodKey.role == KeyRole.SYSTEM_INPUT_METHOD) {
            "Toolbar input-method action must be a system input-method key"
        }
    }
}
