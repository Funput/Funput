...
data class ResolvedSuggestionBar(
     ...
     * as tall as the text needs, so the slack above it, half the gap below it and the
     * padding at the leading edge belong to the suggestions rather than to nothing at all.
     * [KeyboardHitTargetResolver] fills it in.
     */
