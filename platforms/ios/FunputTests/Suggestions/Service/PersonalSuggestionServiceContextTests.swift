...
/// What the service does with the word a prefix is being typed after: forwarding
/// it, asking for a prediction when there is no prefix, and what a prediction
/// looks like once it comes back.
@MainActor
struct PersonalSuggestionServiceContextTests {
