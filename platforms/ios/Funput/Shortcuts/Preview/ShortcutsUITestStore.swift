...
/// UI tests get a unique private temporary directory, never the real App Group.
...
private actor ShortcutsUITestStore: ShortcutsStoring {
    ...
    func load() async throws -> ShortcutLibrary {
        ...
        if seedsSamples && !FileManager.default.fileExists(atPath: directory.appendingPathComponent("shortcuts.json").path) {
